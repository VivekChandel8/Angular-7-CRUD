...
import { InstructorDetailsComponent  } from './components/instructor/details/instructor-detail.component'
import { InstructorAddComponent } from './components/instructor/add/instructor-add.component';
...
@NgModule({
	...
	providers: [AuthService, UserService, StudentService, InstructorService],
